//Cria um escopo para que as variáveis e funções sejam acessíveis apenas através da function utilizando uma IIFE (função imediata) anônima que é executada logo no inicio da aplicação impedindo que esta veenha ser chamada pelo console. Essa configuração segue o paadrão de prrojeto Module Pattern
